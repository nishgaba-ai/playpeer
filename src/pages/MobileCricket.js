    ...
    >
      ...
      >
        <Box
          ...
          p={{ base: "15px", md: "20px" }}
          mb="20px"
          bgImage="url(/images/img_vector_11.png)"
          bgSize="cover"
          bgRepeat="no-repeat"
        >
          {/* <Image
        ...
        /> */}
          ...
          <Text
            ...
            mt="10px"
          >
            Free-2-Play & Play to Earn Blockchain game. It is an ideal game in
            the sports tycoon simulation game. This game is one of the first
